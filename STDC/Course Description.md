...
抄代码的时候呢，我写代码的时候，会在代码中写很多中文。我代码里的中文你不用抄，你只要抄代码本身就可以了。啊！因为、我写中文，你不写中文咋俩的速度基本差不多。啊！你要是抄中文的话，就还是太慢了。如果没有发笔记的情况下，你还是得跟我边听课，边记笔记的。啊！代码中的中文注释部分呢、你下课以后，你在把它补全就可以了。啊！行！那咱就开始讲！
